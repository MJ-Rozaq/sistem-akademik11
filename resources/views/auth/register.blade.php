                ...
                <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
                    ...
                    <form action="{{ route('register') }}" method="POST" class="space-y-6">
                        ...
                        <input id="username" type="text" name="username"
                            class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker @error('username') border-red-500 @enderror"
                        ...
                        <input id="password" type="password" name="password"
                            class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker @error('password') border-red-500 @enderror"
                        ...
                        <select id="role" name="role"
                            class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker @error('role') border-red-500 @enderror"
                            required>
